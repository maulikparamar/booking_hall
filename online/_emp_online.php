<script type="text/javascript" src="../assets/employee_online.js"></script>
            <div  style="width:100%;">
				...
				<input type="hidden" id="dtp_input1" value="" /><br/>
                                                ...
                                                <label>Booking</label><br>
                                                <input type="text" class="form-control" required placeholder="Enter Booking" id="booking" name="booking" />
                                            </div>
...
// 30 Sep 2020 - 09:05 pm
 ...
 function get_data() {
  ...
  for(let i = 0; i < bookedTimes.length ; i++){
    ...
    if(bookedTimes[i].start_time.isSameOrAfter(currentStartTime) && bookedTimes[i].end_time.isSameOrBefore(currentEndTime) && bookedTimes[i].category == category && bookedTimes[i].booking == booking){
