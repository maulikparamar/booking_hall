<script type="text/javascript" src="./assets/admin_online.js"></script>
 <script>
                 ...
                 <div class="col-lg-20" style="width: 100%;">
                     <div class="card">
                         <div class="card-body">
                             ...
                             <h4 class="header-title">Booking info</h4><button class="btn btn-primary waves-effect waves-light mr-1" style="position:reletive; width:10%; float :right;"><a href="./online/excel_online.php" style="color:white">Excel</a></button>
