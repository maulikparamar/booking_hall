<script type="text/javascript" src="assets/sub_admin.js"></script>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form class="custom-validation" id="changepassword">
                                                <input type="hidden" name="action" value="sub_changepassword">
                                            ...
                                            <div class="form-group mb-0">
                                                <div>
                                                    <input type="button" name="button" value="submit" class="btn btn-primary waves-effect waves-light mr-1" onclick="sub_changepassword()" style="width: 7%;">
