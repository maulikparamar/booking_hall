                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Offline Category</h4>    
                               ...
                               <form class="custom-validation"id="booking_add">
                                          ...
                                          <input type="hidden" name="e" id="e">
                                            <div class="form-group">
                                                ...
                                                <label>Offline Category</label><br>
...
// 30 Sep 2020 - 09:05 pm
 ...
 function get_data() {
  ...
  for(let i = 0; i < bookedTimes.length ; i++){
    ...
    if(bookedTimes[i].start_time.isSameOrAfter(currentStartTime) && bookedTimes[i].end_time.isSameOrBefore(currentEndTime) && bookedTimes[i].category == category && bookedTimes[i].booking == booking && bookedTimes[i].confirm == 'Confirm'){
            alert('already booked!!!!!!');
           return; 
        }else if(bookedTimes[i].start_time == start_time &&  bookedTimes[i].end_time == end_time && bookedTimes[i].category == category && bookedTimes[i].booking == booking && bookedTimes[i].confirm == 'Confirm'){
            alert('already booked!!!!!!');
           return;
        }
        console.log(bookedTimes[i].start_time.isSameOrAfter(currentStartTime) && bookedTimes[i].end_time.isSameOrBefore(currentEndTime) && bookedTimes[i].category == category && bookedTimes[i].booking == booking && bookedTimes[i].confirm == 'Confirm');
  }
    booking_add();
    },
  });
